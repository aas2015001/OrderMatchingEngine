...
import com.abdulrauf.omrestfulservice.controllers.BuyController;
...
public class BuyControllerTest {
	...
	@InjectMocks
	private BuyController buyControllerMock;

	@Before
	public void setup() {
		MockitoAnnotations.initMocks(this);
		mockMvc = MockMvcBuilders.standaloneSetup(buyControllerMock)
